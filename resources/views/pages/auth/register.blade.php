...
@endphp
<x-layouts::auth.dashy :title="__('Create account')">
    <x-slot:headerNav>
        <span class="text-[var(--ink-muted)]">Already on Dashy?</span>
        <a href="{{ route('login') }}" wire:navigate class="dashy-header-link">Sign in</a>
    </x-slot:headerNav>
            ...
            <div class="dashy-card" x-data="{ pw: '', strength() {
                ...
                <form method="POST" action="{{ route('register.store') }}" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div>
                            ...
                            <div class="dashy-select-wrap">
                                <select
                                    ...
                                    name="salutation"
                                    class="dashy-select"
                                    x-data="{ v: '{{ old('salutation', '') }}' }"
                                    x-model="v"
                                    :data-empty="!v"
                                >
                                    <option value="" disabled>{{ __('Select') }}</option>
                                    @foreach (Salutation::options() as $value => $label)
                                        <option value="{{ $value }}" @selected(old('salutation') === $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <x-dashy.field-error name="salutation" />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="dashy-input"
                            />
                            <x-dashy.field-error name="first_name" />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="dashy-input"
                            />
                            <x-dashy.field-error name="last_name" />
                        </div>
                    </div>
                    ...
                    <div class="pt-1">
                        ...
                        <x-dashy.field-error name="terms" />
                    </div>
                    ...
                    <a href="{{ route('auth.google.redirect') }}" class="dashy-btn-secondary" aria-label="{{ __('Continue with Google') }}" data-test="google-register">
