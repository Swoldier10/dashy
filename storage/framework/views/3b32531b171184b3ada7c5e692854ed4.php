...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashy.searchable-select','data' => ['wire:model.live' => 'createProjectId','label' => __('Project'),'options' => $projectOptions,'placeholder' => __('Pick a project'),'searchPlaceholder' => __('Search projects…'),'emptyMessage' => __('No projects available.'),'dataTest' => 'task-create-project']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'createProjectId','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Project')),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($projectOptions),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Pick a project')),'searchPlaceholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search projects…')),'emptyMessage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No projects available.')),'data-test' => 'task-create-project']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <div>
                <?php if (isset($component)) { $__componentOriginal18e1f2087a35ad7f1de327d753761793 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18e1f2087a35ad7f1de327d753761793 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashy.searchable-select','data' => ['wire:model' => 'createStatusId','label' => __('Status'),'options' => $statusOptions,'placeholder' => __('Select a status'),'searchPlaceholder' => __('Search statuses…'),'emptyMessage' => __('Pick a project first.'),'dataTest' => 'task-create-status']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dashy.searchable-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'createStatusId','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Status')),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($statusOptions),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Select a status')),'searchPlaceholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search statuses…')),'emptyMessage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Pick a project first.')),'data-test' => 'task-create-status']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($createMembers->isEmpty()): ?>
                <p class="mt-1.5 text-sm" style="color: var(--ink-dim);"><?php echo e(__('Pick a project to see members.')); ?></p>
            <?php else: ?>
                <div class="mt-1.5 flex flex-wrap gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $createMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/livewire/tasks/partials/task-create-drawer-aggregator.blade.php ENDPATH**/ ?>