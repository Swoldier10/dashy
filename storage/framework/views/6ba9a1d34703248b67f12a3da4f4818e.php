...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashy.input','data' => ['name' => 'email','label' => __('Email address'),'type' => 'email','required' => true,'autofocus' => true,'placeholder' => 'email@example.com']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashy.button','data' => ['variant' => 'primary','type' => 'submit','class' => 'w-full','dataTest' => 'email-password-reset-link-button']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-400">
            ...
            <?php if (isset($component)) { $__componentOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashy.link','data' => ['href' => route('login'),'wire:navigate' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dashy.link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af)): ?>
<?php $attributes = $__attributesOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af; ?>
<?php unset($__attributesOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af)): ?>
<?php $component = $__componentOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af; ?>
<?php unset($__componentOriginal94b6f7f7c1e8c7aade3a5b2a7348b6af); ?>
<?php endif; ?>
        </div>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/pages/auth/forgot-password.blade.php ENDPATH**/ ?>