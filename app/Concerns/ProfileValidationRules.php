...
trait ProfileValidationRules
{
    ...
    /**
     * Get the validation rules used to validate the salutation.
     *
     * @return array<int, ValidationRule|array<mixed>|string>
     */
    ...
    /**
     * Get the validation rules used to validate the first name.
     *
     * @return array<int, ValidationRule|array<mixed>|string>
     */
    ...
    /**
     * Get the validation rules used to validate the last name.
     *
     * @return array<int, ValidationRule|array<mixed>|string>
     */
